...
describe("segmentReferenceLinks", () => {
  ...
  it("keeps the surrounding text as plain segments", () => {
    expect(
      ...
      { kind: "link", text: "前条", target: { articleNumber: "15" }, caption: { text: "補助開始の審判", offset: 2 } },
  ...
  it("resolves a paragraph target for a relative paragraph reference", () => {
    ...
    ).toEqual({ kind: "link", text: "前項", target: { articleNumber: "15", paragraphNumber: "1" } });
  });
...
const ReferenceSegment = ({
  ...
  return (
    ...
    >
      ...
      {showCaption ? (
        <span className="text-secondary-foreground">〈{caption.text}〉</span>
      ) : null}
