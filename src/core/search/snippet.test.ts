...
describe("buildSnippet", () => {
  it.each([
    { name: "マッチ範囲が元テキストの一致部分を指す", text: "国家賠償法第一条について定める規定", query: "賠償", radius: 3, slice: "賠償" },
    { name: "先頭一致でも一致部分を指す", text: "秘密を守る義務", query: "秘密", radius: 3, slice: "秘密" },
    { name: "全角半角違いでも元表記を切り出す", text: "第１２条", query: "12", radius: 5, slice: "１２" },
    { name: "NFKC で複数字に展開される元文字は元文字全体を指す", text: "㍿の規定", query: "株式", radius: 5, slice: "㍿" },
